 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font /home/kyph-linux/SquareLine/assets/monogram-extended.ttf -o /home/kyph-linux/SquareLine/assets/ui_font_monogram.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_MONOGRAM
#define UI_FONT_MONOGRAM 1
#endif
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_monogram = {
#else
lv_font_t ui_font_monogram = {
#endif
